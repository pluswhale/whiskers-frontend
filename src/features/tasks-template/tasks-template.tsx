  ...
  return (
    <div className={styles.tasks__wrapper}>
      <div className={styles.tasks__container}>
          ...
          {TASKS_ROWS_DATA &&
            TASKS_ROWS_DATA.map(({ amountToInvite, reward }, index) => (
              <ActionButton
                ...
                imageLeft={<Icon style={{ width: '20px', height: '20px', flexShrink: 0 }} src={inviteIcon} />}
                ...
                stylesForTexts={{
                  ...
                  sub: { fontSize: isMobile ? '14px' : '32px', fontWeight: 'normal', textAlign: 'left', whiteSpace: 'wrap' },
                }}
                stylesForTextsRight={{
        ...
        <Link className={styles.tasks__share} to='https://www.google.com'> {/*swap to telegram channel link*/}
            <div>
